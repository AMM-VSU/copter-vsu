...
//    #define SPARKFUN_5883L_BOB
  ...
  #define MPU6000_I2C           // !!! added by Mikhail
  #include <Platform_MPU6000.h> // !!! added by Mikhail

  // Gyroscope declaration
  // #define ITG3200_ADDRESS_ALTERNATE // !!! changed by Mikhail
  #include <Gyroscope_MPU6000.h>       // !!! changed by Mikhail

  // Accelerometer declaration
  #include <Accelerometer_MPU6000.h> // !!! changed by Mikhail
...
void setup() {
  SERIAL_BEGIN(BAUD);
  SERIAL_PRINTLN("starting"); // !!! added by Mikhail
  pinMode(LED_Green, OUTPUT);
  ...
  SERIAL_PRINTLN("before init sensors"); // !!! added by Mikhail
  ...
  SERIAL_PRINTLN("after init sensors"); // !!! added by Mikhail
  ...
  SERIAL_PRINTLN("started"); // !!! added by Mikhail
  safetyCheck = 0;
}
